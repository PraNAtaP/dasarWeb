...
$totalNilai = 0;
foreach ($dafSiswa as $nilai) {
    $totalNilai += $nilai[1];
}

$rataRata = $totalNilai / count($dafSiswa);

echo "<hr>Siswa di Atas Rata-Rata Kelas <br>";
echo "<br>Rata-rata kelas : $rataRata <br><br>";
foreach ($dafSiswa as $lulus) {
    if ($lulus[1] > $rataRata) {
        echo "Nama: $lulus[0], Nilai: $lulus[1] <br>";
    }
}
